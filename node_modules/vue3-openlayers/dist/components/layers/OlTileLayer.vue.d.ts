import { default as __DTS_DEFAULT_2__ } from 'ol/events/Event';
import { State } from 'ol/source/Source';
import { Extent } from 'ol/extent';
import { default as __DTS_DEFAULT_1__ } from 'ol/renderer/Layer';
import { BackgroundColor } from 'ol/layer/Base';
import { VectorTile, Layer } from 'ol/layer';
...
import { Tile, Source } from 'ol/source';
import { default as __DTS_DEFAULT_0__ } from 'ol/renderer/canvas/TileLayer';
import { LayersCommonProps } from './LayersCommonProps';
import { default as Map, FrameState } from 'ol/Map';
...
declare const _default: __VLS_WithTemplateSlots< DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<LayersCommonProps & {
    ...
    tileLayer: Ref<{
        createRenderer: () => __DTS_DEFAULT_0__<TileLayer< Tile>>;
        ...
        getAttributions: (view?: View | ViewStateLayerStateExtent | undefined) => string[];
        unrender: () => void;
        getDeclutter: () => string;
        ...
        setSource: (source: Tile | null) => void;
        getRenderer: () => __DTS_DEFAULT_0__<TileLayer< Tile> | VectorTile> | null;
        hasRenderer: () => boolean;
        getBackground: () => false | BackgroundColor;
        getClassName: () => string;
        getLayerState: (managed?: boolean | undefined) => State;
        getLayersArray: (array?: Layer<Source, __DTS_DEFAULT_1__<any>>[] | undefined) => Layer<Source, __DTS_DEFAULT_1__<any>>[];
        ...
        dispatchEvent: (event: string | __DTS_DEFAULT_2__) => boolean | undefined;
